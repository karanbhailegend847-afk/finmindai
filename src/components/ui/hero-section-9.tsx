...
// Mock Link since we are in a Vite environment where react-router-dom might be used
// or just standard <a> tags if it's a landing page.
// The provided code used Link from 'next/link', we'll adapt for standard React/Vite.
        ...
        <div className="min-h-screen bg-background text-foreground">
            <header>
                <nav
                    ...
                    className="group fixed z-20 w-full border-b border-dashed border-border bg-background/50 backdrop-blur md:relative">
            ...
            <main>
                <div
                    aria-hidden
                    className="z-[0] absolute inset-0 pointer-events-none isolate opacity-20 contain-strict hidden lg:block overflow-hidden">
                    <div className="w-[35rem] h-[80rem] -translate-y-87.5 absolute left-0 top-0 -rotate-45 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,var(--color-primary)_0,transparent_80%)] blur-3xl" />
                </div>
                    ...
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl text-white">
                                Modern Software testing <span className="text-primary">reimagined</span>
                            </h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl text-muted-foreground">
                                Experience the future of automated quality assurance with our AI-driven platform. Faster, smarter, and deeper insights into your codebase.
                            </p>
                ...
                <section className="bg-background relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-medium text-muted-foreground">Trusted by innovative teams worldwide</h2>
